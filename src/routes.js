...
import TutorList from './components/tutor/search/tutor-list';
import FindATeacher from './components/tutor/search/find-a-tutor';
...
export default (
  <Route>
    ...
    <Route component={App} onEnter={checkLogin}>
      <Route path="/" component={FindATeacher} />
